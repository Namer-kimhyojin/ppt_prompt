(function () {
  ...
  var guides = {
    ...
    "pptx-request": {
      name: "PPTX 제작 요청문",
      overview: "스타일 갤러리에서 디자인을 고르고 오른쪽에서 발표 조건과 완성 요청문을 확인합니다.",
      detail: "선택한 스타일과 제작 조건을 확인하는 영역입니다. 원문을 직접 넣거나 별도 파일로 제작 AI에 함께 전달할 수 있습니다.",
      detailSize: [680, 720],
      nodes: [["선택", "발표자료 스타일"], ["조건", "규격·목적·장수"], ["내용", "원문 또는 별도 첨부"], ["결과", "PPTX 제작 요청문"]]
    },
    "document-design": {
      name: "문서 디자인",
    ...
    "form-image": {
      ...
      detailSize: [655, 720],
      nodes: [["선택", "표지·간지·배경 등"], ["입력", "제목·기관명·날짜"], ["설계", "유형·스타일·보기"], ["결과", "문서 표지·양식 프롬프트"]]
    },
    "map-image": {
      name: "지도·위치도",
    ...
    "promotion-image": {
      name: "홍보 이미지",
      overview: "홍보 원문을 정리하고 오른쪽 결과 요약·구성 참고도·완성 프롬프트를 확인합니다.",
      detail: "원문 분석이나 샘플 적용 후 제목·핵심 내용·보조 설명을 검토하고 고치는 입력 영역입니다.",
      detailSize: [655, 720],
      nodes: [["입력", "원문·샘플"], ["검토", "문구·규격·QR"], ["설계", "구성 참고도·추천 스타일"], ["활용", "편집·복사·템플릿"]]
    },
    "qr-code": {
      name: "QR코드",
