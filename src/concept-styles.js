// 컨셉 스타일 데이터 — concept-suggest.js 렌더링 엔진에서 window.CONCEPT_STYLES 로 참조
// 이 파일은 concept-suggest.js 보다 먼저 로드되어야 합니다.

window.CONCEPT_STYLES = [
