  ...
  const VARIATION_SEEDS = [
    {
      ...
      linesKo: [
        ...
        "텍스트 색상 수는 최대 3가지로 제한하고, 텍스트에 대한 포인트 색상은 CTA요소에만 사용한다",
      ],
      linesEn: [
        ...
        "Limit text colors to 3 maximum; reserve accent color for text on CTA elements only",
      ],
    },
    {
      id: "visual",
  ...
  const STEP3_IDEA_PRESETS = [
    {
      ...
      fields: {
        tone: "신뢰감, 전문적, 차분함",
        bigIdea: "신뢰",
        visualMetaphor: "안정적인 정보 카드와 명확한 텍스트 구조",
        visualStyle: "공공 안내형, 미니멀 정보형",
        commercialBaseline: "standard",
        antiAiStyle: "minimal_typo",
      },
    },
    {
      id: "event",
      ...
      fields: {
        tone: "활기, 기대감, 현대적",
        bigIdea: "참여",
        visualMetaphor: "에너지가 모이는 중심 공간과 조명",
        visualStyle: "에디토리얼 광고형, 대담한 타이포그래피",
        commercialBaseline: "premium",
        antiAiStyle: "general",
      },
    },
    {
      id: "education",
      label: "교육·모집형",
      desc: "수강생·참가자 모집, 교육 안내",
      fields: {
        tone: "따뜻함, 긍정적, 신뢰감",
        bigIdea: "기회",
        visualMetaphor: "열린 문과 빛의 방향",
        visualStyle: "미니멀 정보형, 따뜻한 캐릭터형",
        commercialBaseline: "standard",
        antiAiStyle: "general",
      },
    },
    {
      ...
      fields: {
        tone: "친근함, 차분함, 신뢰감",
        bigIdea: "연결",
        visualMetaphor: "여러 응답이 하나로 모이는 흐름",
        visualStyle: "미니멀 정보형, 인포그래픽형",
        commercialBaseline: "standard",
        antiAiStyle: "general",
      },
    },
    {
      ...
      fields: {
        tone: "활기, 혁신적, 임팩트",
        bigIdea: "전환",
        visualMetaphor: "제품이 빛 속에서 등장하는 장면",
        visualStyle: "제품 광고형, 하이엔드 캠페인형",
        commercialBaseline: "premium",
        antiAiStyle: "photo_real",
      },
    },
    {
      id: "recruitment",
      label: "채용·모집형",
      desc: "인재 채용, 팀원·자원봉사 모집",
      fields: {
        tone: "전문적, 활기, 미래지향",
        bigIdea: "성장",
        visualMetaphor: "상승하는 경로와 가능성의 공간",
        visualStyle: "에디토리얼 광고형, 테크 UI형",
        commercialBaseline: "premium",
        antiAiStyle: "general",
      },
    },
    {
      id: "promo-offer",
      label: "할인·프로모션형",
      desc: "특가, 한정 혜택, 이벤트 오퍼",
      fields: {
        tone: "임팩트, 긴박감, 활기",
        bigIdea: "기회",
        visualMetaphor: "강렬한 숫자와 시간의 긴박감",
        visualStyle: "대담한 타이포그래피, 제품 광고형",
        commercialBaseline: "premium",
        antiAiStyle: "general",
      },
    },
    {
      id: "brand-campaign",
      label: "브랜드·캠페인형",
      desc: "브랜드 가치, 기업 이미지 홍보",
      fields: {
        tone: "프리미엄, 세련된, 감성적",
        bigIdea: "신뢰",
        visualMetaphor: "브랜드 핵심 오브젝트가 공간을 채우는 키비주얼",
        visualStyle: "하이엔드 캠페인형, 매거진 커버형",
        commercialBaseline: "premium",
        antiAiStyle: "photo_real",
      },
    },
