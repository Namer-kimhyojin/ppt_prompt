...
(function (root) {
  ...
  const FIELD_DEFINITIONS = Object.freeze([
    ...
    { key: "front.title", label: "앞면 제목", target: "front_title", side: "front", aliases: ["front_title", "앞면제목", "제목", "title", "성명", "이름", "name", "품명", "항목명"] },
    { key: "front.subtitle", label: "앞면 부제", target: "front_subtitle", side: "front", aliases: ["front_subtitle", "앞면부제", "부제", "subtitle", "소속", "기관", "기관명", "회사", "회사명", "과정", "과정명"] },
    { key: "front.body", label: "앞면 본문", target: "front_body", side: "front", aliases: ["front_body", "앞면본문", "본문", "내용", "body", "content", "구분", "category", "종류", "식권종류", "역할", "role", "좌석", "좌석번호"] },
